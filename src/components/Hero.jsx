        ...
        <section className="top-section h-[calc(100dvh-5rem)] flex flex-col justify-evenly items-center overflow-hidden">
            <div className="font-hero text-center">
                ...
                <div id="header-text" className='mt-5 text-xl md:text-3xl text-center'>
                    <p>A <strong className='italic mx-[1px] md:mx-[2px]'>Front-end Web Developer</strong> passionate in building creative webpages.</p>
            ...
            <div id="btn-container" className='flex flex-col gap-5 md:flex-row'>
                <Link to="/projects">
                    <button className='bg-black text-white font-bold px-15 py-3 border rounded-full hover:bg-white hover:text-black cursor-pointer'>Projects</button>
                </Link>
                <Link to="/contact">
                    <button className='font-bold px-15 py-3 border rounded-full hover:bg-black hover:text-white cursor-pointer'>Contact</button>
                </Link>
            </div>
        </section>
    )
